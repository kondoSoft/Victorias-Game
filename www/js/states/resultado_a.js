var resultadoA_State = {
  create: function(){
    ...
    //Image Words
    if (jscd.os == 'iOS') {
      this.plane = game.add.image(80,130,'avion')
      this.plane.rotation = -0.050

      this.bee = game.add.image(560, 110, 'abeja')
      this.bee.rotation = 0.050
    }else {
      this.plane = game.add.image(game.world.centerX - 470,130,'avion')
      this.plane.rotation = -0.050

      this.bee = game.add.image(game.world.centerX + 80, 110, 'abeja')
      this.bee.rotation = 0.0508
    }
