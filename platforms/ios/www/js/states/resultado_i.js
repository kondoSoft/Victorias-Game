var resultadoI_State = {
  create: function(){
    ...
    //Image Words
    if (jscd.os == 'iOS') {
      this.church = game.add.image(80,130,'iglesia')
      this.church.rotation = -0.050

      this.iguana = game.add.image(560, 110, 'iguana')
      this.iguana.rotation = 0.050
    }else {
      this.church = game.add.image(game.world.centerX - 470,130,'iglesia')
      this.church.rotation = -0.050

      this.iguana = game.add.image(game.world.centerX + 80, 110, 'iguana')
      this.iguana.rotation = 0.050
    }
